  ...
  describe('functions', function() {
    ...
    describe('displayEditForm', function() {
      it('renders the form template with values pre-filled', function() {
        ...
        ingredientsValues.forEach(function(ing, index){
          expect(ingredients[index].value).toEqual(ing, "Got: '" +"$$$$"+ingredients.innerHTML+"$$$"+ ingredients[index].value + "' Expected: '" + ing + "' Make sure that the ingredients fields are pre-filled in the edit form");
        })
